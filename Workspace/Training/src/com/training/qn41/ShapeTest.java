...
public class ShapeTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("1.Rectangle 2.Square 3.Circle Area Calculator 4. Hexagon Area Calculator --- Choose your shape ");
		choice = sc.nextInt();
		...
		case 4:
			...
			sp = new Hexagon(sideHexa);	
			System.out.println("Area of Hexagon is: "+sp.calculateArea());		
			break;
